...
<head>
    ...
    <title>UMKM - <?php echo e(config('app.name')); ?> </title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/styles/mai_styles.css')); ?>">
                ...
                <ul class="menu_top_nav">
                    ...
                    <li class="menu_item has-children">
                        ...
                        <ul class="menu_selection">
                            ...
                            <li><a href="<?php echo e(url('/admin-products')); ?>"><i class="fa fa-btn fa-cubes"></i>Iklan Saya</a>
                            </li>
                            <li><a href="<?php echo e(url('/admin-products/create')); ?>"><i
